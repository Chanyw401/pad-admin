<template>
    <div>
        <div class="car-box">
            <header-one :data="{name:'您的肠道菌群构造',nameEn:'Your gut microbiota structure',No:'NO：BG202304172012',date:''}"/>
            ...
            <header-tow :data="{name:'核心菌属表\n',nameEn:'List of core bacterial genera'}"/>
            <div>
                <div class="theader">
                    <div style="width: 40%;text-align: left;padding-left: 30px">检测菌属</div>
                    <div style="width: 15%;text-align: center ">丰度%</div>
                    <div style="width: 15%;text-align: center "> 状态</div>
                    <div style="width: 30%;text-align:center">参考范围</div>
                </div>
                <div class="t-body">
                    <div v-for="(item,index) in tableList   " :key="index" class="item">
                        ...
                        <div style="width: 15%;text-align: center ">
                            <div v-show="item.state== 0">-</div>
                            <div v-show="item.state== 1"><img src="../../assets/img/car-pdf/down.png" alt=""></div>
                            <div v-show="item.state== 2"><img src="../../assets/img/car-pdf/rise.png" alt=""></div>
                        </div>
...
export default {
    ...
    data() {
        return {
            tableList: [
                {name: '厚壁菌门 Firmicutes', value: '59.545%', value2: 15, state: 0},
                {name: '拟杆菌门 Bacteroidetes', value: '59.545%', value2: 35,state: 1},
                {name: '变形菌门 Proteobacteria', value: '59.545%', value2: 45,state: 1},
                {name: '放线菌门 Actinobacteria', value: '59.545%', value2: 55,state: 2},
                {name: '螺旋体 Spirochaetes', value: '59.545%', value2: 100,state: 2},
                {name: '放线菌门 Actinobacteria', value: '59.545%', value2: 55,state: 2},
                {name: '螺旋体 Spirochaetes', value: '59.545%', value2: 100,state: 2},
            ]
